...
export const countriesMeta: Record<string, CountryMeta> = {
    ...
    德国: {
        weight: 70,
        pattern:
            "德国|德|柏林|法兰克福|慕尼黑|Munich|\\b(?:DE|de)(?:[-_ ]?\\d+(?:[-_ ]?[A-Za-z]{2,})?)?\\b|Germany|GERMANY|DEU|MUC|FRA|🇩🇪",
    ...
    荷兰: {
        weight: 75,
        pattern:
            "荷兰|阿姆斯特丹|Amsterdam|\\b(?:NL|nl)(?:[-_ ]?\\d+(?:[-_ ]?[A-Za-z]{2,})?)?\\b|Netherlands|NETHERLANDS|Holland|AMS|🇳🇱",
